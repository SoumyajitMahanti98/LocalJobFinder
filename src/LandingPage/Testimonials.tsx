...
const Testimonials = () => {
    return <div className="mt-20 pb-5 p-5 overflow-hidden">
        ...
        {
            testimonials.map((data: Testimonial, index: number)=><div data-aos="zoom-in" key={index} className="flex flex-col gap-3 w-[23%] md-mx:w-[48%] xs-mx:w-full border-bright-sun-400 p-3 border rounded-xl">
